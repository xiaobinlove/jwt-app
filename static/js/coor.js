...
function getAddress (jd,wd, success, fail) {
  console.log(jd,wd, 'jd,wd')
  // lon纬度
  // lat精度
  var postStr = {
    'lon':wd,'lat':jd,'ver':1
  ...
  xh.post_dg("http://api.tianditu.gov.cn/geocoder", param, function(res){
    var ret = eval('(' + res.returnValue + ')');
    // alert(ret.result.formatted_address)
    console.log(res, 'addresserr')
...
export {bd09togcj02, gcj02tobd09, wgs84togcj02, gcj02towgs84, getDisance, getAddress}
