...
;(function (window) {
    ...
    */
    ...
    /**
     ...
     @static
     @param code e:"OpenBuiltIn"
     @param key e:"StartNewDisk"
     @example
     app.link.openLinkPage();
     */
    app.link.openLinkPage = function (code, key) {
        var params={
            code:code,
            key:key
        };
    ...
    /**
     打开云盘页面
     @method app.link.openCloudDisk
     @static
     @example
     app.link.openCloudDisk();
     */
    app.link.openCloudDisk = function () {
        var params={
            code:"OpenBuiltIn",
            key:"StartNewDisk"
        };
    ...
    /**
     ...
     @param params 参数优先定位模式
     */
    app.link.getAddressInfo = function (callback,failCallback,params) {
        Cordova.exec(callback,failCallback, "LinkPlugin", "getAddressInfo", [params]);
    }
    ...
    /**
     ...
     @param params 经纬度
     */
    app.link.getDetailAddress = function (callback,failCallback,params) {
        Cordova.exec(callback,failCallback, "LinkPlugin", "getDetailAddress", [params]);
    }
    ...
    /**
     ...
     @param params 地址
     */
    app.link.getLongAndLat = function (callback,failCallback,params) {
        Cordova.exec(callback,failCallback, "LinkPlugin", "getLongAndLat", [params]);
    }
