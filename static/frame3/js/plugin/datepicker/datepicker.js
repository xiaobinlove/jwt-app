...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        * @param {Object} t - Target wheel Zepto object.
        ...
        preset = function (inst) {
            ...
            if (p.match(/time/i)) {
                ...
                $.each(['h', 'i', 's', 'a'], function (i, v) {
                    ...
                    if (i > -1 && new RegExp(v,"i").test(hformat)) {
                        ord.push({ o: i, v: v });
                    }
                });
            ...
            return {
                ...
                * @param {Object} dw - Zepto object containing the generated html
                ...
                */
                ...
                methods: {
                    ...
                    * @param {Boolean} [fill] - Also set the value of the associated input element. Default is true.
                    * @return {Object} - Zepto object to maintain chainability
                    */
...
/**
           组件初始化 
    @method  $(selector).datepicker(options)
    @param preset {String} 日期类型 ，取值  'datetime' | 'date' | 'time'
    @param display {String} 显示方式， 具体参数如下
	<ul>
	<li>bottom:		底部</li>
	<li>top:		顶部 </li>
	<li>modal:		居中</li>
	...
	@param timeFormat  {String} 时间格式 （<font color=red>使用ii代替分钟mm,避免与月份冲突</font>）,
	@param startYear {String} 开始年份
	@param endYear {String} 结束年份
	@param showNow {Boolean} 是否显示今天的按钮
	@param nowText {String} 今天按钮显示的文本
*/
(function ($) {
   ...
   $.fn.datepicker = function(options){
  		...
  		if(options.dateFormat) 
  			options.dateFormat = options.dateFormat.replace("yyyy", "yy");
   		$(this).mobiscroll($.extend(options, defaultOpts));
   }
